# Template Balasan Krisna Media

> **SOUND • LIGHTING • STUDIO • GEAR**
> Banjarmasin, Kalimantan Selatan
> Copy-paste sesuai situasi. Ganti `[..]` dengan data real.

---

## 1. Booking Baru Masuk (via Website)
...
📅 Tanggal: [tanggal]
⏰ Jam: [jam] - [selesai]
🔊 Layanan: [Sound System / Lighting / Studio Musik / dll]
📍 Lokasi: [lokasi]

Kami akan segera hubungi kamu untuk konfirmasi lebih lanjut. Stay tuned ya!
```

---

## 2. Konfirmasi Booking (DP Diterima)
...
Ada yang mau ditanyakan? Feel free to chat ya!
```
...
Mohon dilunasi sebelum [batas waktu]. Transfer ke:
🏦 BCA — 1234567890 — a.n. Krisna Media
...
Tanggal yang tersedia untuk [bulan]:
• [tgl1]
• [tgl2]
• [tgl3]

Mau lihat detail lengkapnya? Bisa cek krisnamedia.id atau bilang aja mau booking yang mana, kita atur!
```

---

## 6. Tanya Info Studio Musik / Happy Hour
...
🎉 Happy Hour (diskon khusus):
  [hari & jam tertentu] — harga lebih murah

Add-on gear tersedia:
  • Mic, headphone, kabel, efek, dll.

Lokasi studio: [alamat]
Bisa cek ketersediaan jam di krisnamedia.id atau langsung tanya aja!
```

---

## 7. Reschedule dari Customer
...
Kalau ada biaya perubahan (jika < H-3) akan kami infokan ya.

Konfirm aja tanggal mana yang cocok!
```
...
❌ [Jika non-refundable] — Sudah sesuai kebijakan pembatalan.

Maaf dan terima kasih. Kalau lain waktu butuh lagi, jangan ragu ya!
```

---

## 9. After Event — Terima Kasih
...
Kalau ada kendala alat (sound/lighting/studio), jangan sungkan lapor. Sampai ketemu di acara berikutnya! 🔥
```

---

## 10. Pengambilan / Pengembalian Alat

*Untuk sewa alat yang diambil/dikembalikan.*
...
Atau kalau ada kritik/saran, kita terbuka banget!
```

---

## 12. Follow-up (No Response)
...
Kalau ada perubahan rencana juga gapapa, kasih kabar aja ya!
```

---

## 13. Tanya Kursus Musik (KMC)
...
Info lengkap & pendaftaran: [link KMC]
Atau tanya aja langsung, kita bantu!
```

---

> **Referensi Harga (Update Terakhir: 2026)**
>
> 🔊 **Sound System:** Basic Rp1,5jt | Medium Rp3jt | Large Rp5jt
> 💡 **Lighting:** Basic Rp1jt | Medium Rp2,5jt | Large Rp4,5jt
> 🎵 **Studio:** Per Jam Rp75rb | 3 Jam Rp200rb | 5 Jam Rp300rb
> 🎸 **Senar Gitar:** Akustik Rp50rb | Elektrik Rp65rb | Bass Rp120rb
>
> Kontak: 0811-519-1097 | krisnamedia.id