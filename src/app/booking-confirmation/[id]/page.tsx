      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="animate-fade-in">
            ...
            <p className="inline-flex items-center gap-2 text-sm text-green-400 font-medium tracking-wider uppercase mb-4 border border-green-500/30 rounded-full px-4 py-1.5 glass">
              Booking Berhasil!
            </p>
          </div>
          ...
          <p className="animate-fade-in delay-200 text-muted text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            Terima kasih! Permintaan booking Anda telah kami terima. Tim Krisna
            Media akan menghubungi Anda segera melalui WhatsApp.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-10 space-y-4 animate-fade-in-up delay-200">
            ...
            >
              ...
              Hubungi Krisna Media via WhatsApp
            </a>
